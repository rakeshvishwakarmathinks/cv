var Colors = {
  ...
  brownDark: 0x23190f,
  blue: 0x68c3c0,
  glowBlue: 0x80ffdb, // for the sun
  green: 0x458248 /*green: 0x458248 */,
  purple: 0x551a8b,
  lightgreen: 0x629265 /*lightgreen: 0x629265*/,
};
...
function createScene() {
  ...
  scene.fog = new THREE.Fog(0x410055, 100, 950);
  // Create the camera
...
Sun = function () {
  ...
  var sunGeom = new THREE.SphereGeometry(300, 20, 20);
...
Cloud = function () {
  ...
  var nBlocs = 3 + Math.floor(Math.random() * 3); // number of clouds
...
Flower = function () {
  ...
  //this.mesh.add(stem);               // Flower stem visibility
  ...
  //this.mesh.add(petalCore);    // flower petal visibility
};
